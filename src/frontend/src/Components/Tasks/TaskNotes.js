      ...
      <Row>
        <Col>
          ...
          <div className="task-notes-content">
            ...
            {
              <TaskNotesList task={task} notes={notes} noteTypes={noteTypes} updateNotePropagate={updateNotePropagate} removeNotePropagate={removeNotePropagate} addNote={addNote}></TaskNotesList>
            }
          </div>
        </Col>
      </Row>  
