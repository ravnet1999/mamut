            ...
            { props.loggedIn ? <Container className="margin-bottom-default">
                <Row>
                    <Col>
                        <nav>
                            <ul>
                                <li><Link to='/representatives-search' className={props.currentPage.includes('/representatives-search') ? 'active' : ''}>Reprezentanci</Link></li>
                                <li><Link to='/clients' className={props.currentPage.includes('/clients') || props.currentPage.includes('/representatives') &&  !props.currentPage.includes('/representatives-search') ? 'active' : ''}>Klienci</Link></li>
